...
export const accountName = document.querySelector(".account__name");
export const accountIconsTitle = document.querySelector(
  ".account__description"
);
export const accountForm = document.querySelector("#account__edit");
...
export const popupAddPlaceForm = document.querySelector("#add__place");
