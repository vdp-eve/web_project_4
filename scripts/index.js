...
const editAccountPopup = document.querySelector(".popup_type_edit-account");
const addCardPopup = document.querySelector(".popup_type_add-card");
const imagePopup = document.querySelector(".popup_type_image-preview");

//Forms
const formAccount = document.querySelector(".form_type_account");
...
const closeAccountPopupButton = document.querySelector(
  ".popup__button-close_type_account"
);
...
const addCardButton = document.querySelector(".account__button_type_add");
