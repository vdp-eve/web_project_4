...
const popupAccountName = document.querySelector(".edit__account-name");
const popupAccountIconsTitle = document.querySelector(
  ".edit__account-occupation"
);
...
const popupPlaceName = document.querySelector(".place__name");
const popupPlaceUrl = document.querySelector(".place__link");
